    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-red-50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold">Welcome to Pizza Dashboard</CardTitle>
          <CardDescription>
            Sign in with your Google account to access your pizza order management system
          </CardDescription>
        </CardHeader>
        <CardContent>
